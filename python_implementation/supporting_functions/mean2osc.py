...
def atan3(y, x):
    """
    Four-quadrant arctangent function similar to atan2 but with different behavior
    """
...
def anomly(nflg, ain, e):
    """
    Orbital anomaly conversion function
...
def delm(x, param):
    ...
    Returns:
        dx: J2 perturbations to orbital elements [6x1]
    """
